...
# manager_vladimir = User(id=1, name='Vladimir_manager', conversation=597, role_id=1)
# client_demasek = User(id=2, name='Demasek_client', conversation=100, role_id=2)
# test_ticket1 = Ticket(id=1, manager_id=manager_vladimir.id, client_id=client_demasek.id, title='Вова Проблема все еще есть!')
